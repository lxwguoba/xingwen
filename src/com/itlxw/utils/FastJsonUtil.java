...
public class FastJsonUtil {
	...
	public static String ajaxResult(boolean success, String message) {
		Map map = new HashMap();
		map.put("code", 200);// 是否成功
		map.put("oid", message);// 文本消息
		String json = JSON.toJSONString(map);
		return json;
	}
	
	public static String ajaxResult(String message) {
		Map map = new HashMap();
		map.put("code", 200);// 是否成功
		map.put("msg", message);// 文本消息
		String json = JSON.toJSONString(map);
		return json;
	}
	
	public static String ajaxResultFail(String message) {
		Map map = new HashMap();
		map.put("code", 201);// 是否成功
		map.put("msg", message);// 文本消息
		String json = JSON.toJSONString(map);
		return json;
	}
